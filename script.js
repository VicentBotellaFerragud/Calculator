...
/**
 * This map function/method applies an "addEventListener" function/method to each element of the "buttons" collection.
 */
buttons.map(button => {
    ...
    button.addEventListener('click', (e) => {
        ...
        switch (e.target.innerText) {
            ...
            case '=':
                ...
                //If the user types in invalid mathematic operations, "Error" is displayed in the "display" div.
                } catch {
            ...
            case '←':
                ...
                //And there is something in the "display" div...
                if (display.innerText) {

                    //The last character of the "display" string is removed.
            ...
            //This adds by default the inner text of the button (its content) to the inner content of the "display" div.
            default:
